...
public class RepExamenesMedicosProcesados extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepExamenesMedicosProcesados() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepExamenesMedicosProcesados(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepExamenesMedicosProcesados reporte = new RepExamenesMedicosProcesados();
