...
public class RepCartaAvalPorSede extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepCartaAvalPorSede() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepCartaAvalPorSede(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepCartaAvalPorSede reporte = new RepCartaAvalPorSede();
