...
public class RepGastosBeneficiadosPorMes extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepGastosBeneficiadosPorMes() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepGastosBeneficiadosPorMes(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepGastosBeneficiadosPorMes reporte = new RepGastosBeneficiadosPorMes();
