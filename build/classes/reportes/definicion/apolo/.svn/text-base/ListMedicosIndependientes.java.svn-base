...
public class ListMedicosIndependientes extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public ListMedicosIndependientes() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public ListMedicosIndependientes(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		ListMedicosIndependientes reporte = new ListMedicosIndependientes();
