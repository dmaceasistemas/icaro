...
public class SolicitudPagoMedicosObreros extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public SolicitudPagoMedicosObreros() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public SolicitudPagoMedicosObreros(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		SolicitudPagoMedicosObreros reporte = new SolicitudPagoMedicosObreros();
