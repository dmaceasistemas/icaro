...
public class SolicitudPagoMedicosEmpleados extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public SolicitudPagoMedicosEmpleados() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public SolicitudPagoMedicosEmpleados(HttpServletRequest request) {
		super(request);
	...
	public void cargarParametros(HttpServletRequest request) {	
		...
		this.parametros.put("cod_med",cod_med);
	...
	public Object clone() throws CloneNotSupportedException {
		SolicitudPagoMedicosEmpleados reporte = new SolicitudPagoMedicosEmpleados();
