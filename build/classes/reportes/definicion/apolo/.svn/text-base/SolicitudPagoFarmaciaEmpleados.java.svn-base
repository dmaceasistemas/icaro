...
public class SolicitudPagoFarmaciaEmpleados extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public SolicitudPagoFarmaciaEmpleados() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public SolicitudPagoFarmaciaEmpleados(HttpServletRequest request) {
		super(request);
	...
	public void cargarParametros(HttpServletRequest request) {	
		String cod_farmacia = request.getParameter("cod_farmacia");
		...
		this.parametros.put("cod_farmacia",cod_farmacia);
	...
	public Object clone() throws CloneNotSupportedException {
		SolicitudPagoFarmaciaEmpleados reporte = new SolicitudPagoFarmaciaEmpleados();
