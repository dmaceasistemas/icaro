...
public class RepClienteComite extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepClienteComite() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepClienteComite(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepClienteComite reporte = new RepClienteComite();
