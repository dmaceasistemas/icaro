...
public class RepNotaCredito extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepNotaCredito() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepNotaCredito(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepNotaCredito reporte = new RepNotaCredito();
