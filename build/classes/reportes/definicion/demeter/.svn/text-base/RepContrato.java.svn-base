...
public class RepContrato extends Reporte{
	...
	public RepContrato(HttpServletRequest request) {
		super(request);
...
/*		 int fechames = Integer.parseInt( request.getParameter("fechames"));		
	...
	public Object clone() throws CloneNotSupportedException {
		RepContrato reporte = new RepContrato();
	...
	try {
		...
		generador.generarReporteHTML(nombreReporte,"demeter", this.parametros, conn, response);
		/*
