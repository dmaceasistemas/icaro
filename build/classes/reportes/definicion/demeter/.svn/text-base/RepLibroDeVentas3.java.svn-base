...
public class RepLibroDeVentas3 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepLibroDeVentas3() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepLibroDeVentas3(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepLibroDeVentas3 reporte = new RepLibroDeVentas3();
	...
	try {
		...
		generador.generarReporteXLS(nombreReporte, "demeter",this.parametros, conn, response);
