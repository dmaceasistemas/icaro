...
public class RepSaldoFacturas extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepSaldoFacturas() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepSaldoFacturas(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepSaldoFacturas reporte = new RepSaldoFacturas();
