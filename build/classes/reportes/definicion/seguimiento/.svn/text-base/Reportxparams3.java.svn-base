...
public class Reportxparams3 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public Reportxparams3() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public Reportxparams3(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		Reportxparams3 reporte = new Reportxparams3();
