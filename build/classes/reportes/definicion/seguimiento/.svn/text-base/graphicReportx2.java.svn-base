...
public class graphicReportx2 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public graphicReportx2() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public graphicReportx2(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		graphicReportx2 reporte = new graphicReportx2();
