...
public class graphicReportx4 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public graphicReportx4() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public graphicReportx4(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		graphicReportx4 reporte = new graphicReportx4();
