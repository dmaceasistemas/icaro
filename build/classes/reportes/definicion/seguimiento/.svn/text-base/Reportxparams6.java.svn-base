...
public class Reportxparams6 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public Reportxparams6() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public Reportxparams6(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		Reportxparams6 reporte = new Reportxparams6();
