...
public class RepGastoViaticos extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepGastoViaticos() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepGastoViaticos(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepGastoViaticos reporte = new RepGastoViaticos();
