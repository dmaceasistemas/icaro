...
public class RepRegistroDespacho extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepRegistroDespacho() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepRegistroDespacho(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepRegistroDespacho reporte = new RepRegistroDespacho();
