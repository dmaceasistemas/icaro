...
public class RepRegistroNacionalizacion extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepRegistroNacionalizacion() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepRegistroNacionalizacion(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepRegistroNacionalizacion reporte = new RepRegistroNacionalizacion();
