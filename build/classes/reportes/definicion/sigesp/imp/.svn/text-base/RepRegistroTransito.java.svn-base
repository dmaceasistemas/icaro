...
public class RepRegistroTransito extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepRegistroTransito() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepRegistroTransito(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepRegistroTransito reporte = new RepRegistroTransito();
