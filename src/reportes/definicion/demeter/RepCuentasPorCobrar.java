...
public class RepCuentasPorCobrar extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepCuentasPorCobrar() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepCuentasPorCobrar(HttpServletRequest request) {
		super(request);
	...
	public void cargarParametros(HttpServletRequest request) {		
		 /*  int idcomite = Integer.parseInt( request.getParameter("idcomite"));		
		this.parametros.put("IdComite",idcomite);	*/
	}
	...
	public Object clone() throws CloneNotSupportedException {
		RepCuentasPorCobrar reporte = new RepCuentasPorCobrar();
