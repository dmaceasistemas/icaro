...
public class RepClienteComiteSaldo extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepClienteComiteSaldo() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepClienteComiteSaldo(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepClienteComiteSaldo reporte = new RepClienteComiteSaldo();
