...
public class RepLibroDeVentas extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepLibroDeVentas() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepLibroDeVentas(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepLibroDeVentas reporte = new RepLibroDeVentas();
