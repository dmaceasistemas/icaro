...
public class RepImpMemoRapido extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepImpMemoRapido() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepImpMemoRapido(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepImpMemoRapido reporte = new RepImpMemoRapido();
