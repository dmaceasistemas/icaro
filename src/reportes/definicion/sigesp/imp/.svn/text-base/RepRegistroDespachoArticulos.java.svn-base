...
public class RepRegistroDespachoArticulos extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepRegistroDespachoArticulos() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepRegistroDespachoArticulos(HttpServletRequest request) {
		super(request);
	...
	public void cargarParametros(HttpServletRequest request) {
		...
		String dirSubRep   = inicio.class.getResource("/").getPath()+"reportes/fuentes/sigesp/imp/";
		...
		this.parametros.put("SUBREPORT_DIR",dirSubRep);
	}
	...
	public Object clone() throws CloneNotSupportedException {
		RepRegistroDespachoArticulos reporte = new RepRegistroDespachoArticulos();
