...
public class RepRegistroRecepcion extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepRegistroRecepcion() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepRegistroRecepcion(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepRegistroRecepcion reporte = new RepRegistroRecepcion();
