...
public class RepEmergenciaMedica extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepEmergenciaMedica() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepEmergenciaMedica(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepEmergenciaMedica reporte = new RepEmergenciaMedica();
