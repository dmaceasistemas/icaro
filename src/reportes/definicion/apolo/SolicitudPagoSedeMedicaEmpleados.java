...
public class SolicitudPagoSedeMedicaEmpleados extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public SolicitudPagoSedeMedicaEmpleados() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public SolicitudPagoSedeMedicaEmpleados(HttpServletRequest request) {
		super(request);
	...
	public void cargarParametros(HttpServletRequest request) {	
		String cod_sedmed = request.getParameter("cod_sedmed");
		...
		this.parametros.put("cod_sedmed",cod_sedmed);
		//this.parametros.put("memo",memo);
	...
	public Object clone() throws CloneNotSupportedException {
		SolicitudPagoSedeMedicaEmpleados reporte = new SolicitudPagoSedeMedicaEmpleados();
