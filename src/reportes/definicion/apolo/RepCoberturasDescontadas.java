...
public class RepCoberturasDescontadas extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepCoberturasDescontadas() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepCoberturasDescontadas(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepCoberturasDescontadas reporte = new RepCoberturasDescontadas();
