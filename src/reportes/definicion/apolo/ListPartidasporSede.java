...
public class ListPartidasporSede extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public ListPartidasporSede() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public ListPartidasporSede(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		ListPartidasporSede reporte = new ListPartidasporSede();
