...
public class RepTratamientoPermanente2 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepTratamientoPermanente2() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepTratamientoPermanente2(HttpServletRequest request) {
		super(request);
	...
	public void cargarParametros(HttpServletRequest request) {	
		...
		String nroOrden = request.getParameter("nroOrden");
		...
		this.parametros.put("nroOrden",nroOrden);
	...
	public Object clone() throws CloneNotSupportedException {
		RepTratamientoPermanente2 reporte = new RepTratamientoPermanente2();
