...
public class RepCartaAvalMensual extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepCartaAvalMensual() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepCartaAvalMensual(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepCartaAvalMensual reporte = new RepCartaAvalMensual();
