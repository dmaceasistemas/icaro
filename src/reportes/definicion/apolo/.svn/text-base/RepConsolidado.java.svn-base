...
public class RepConsolidado extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepConsolidado() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepConsolidado(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepConsolidado reporte = new RepConsolidado();
