...
public class SolicitudPagoReembolsoEmpleados extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public SolicitudPagoReembolsoEmpleados() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public SolicitudPagoReembolsoEmpleados(HttpServletRequest request) {
		super(request);
	...
	public void cargarParametros(HttpServletRequest request) {	
		String ced_emp = request.getParameter("ced_emp");
		...
		this.parametros.put("ced_emp",ced_emp);
	...
	public Object clone() throws CloneNotSupportedException {
		SolicitudPagoReembolsoEmpleados reporte = new SolicitudPagoReembolsoEmpleados();
