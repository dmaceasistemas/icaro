...
public class SolicitudPagoFarmaciaObreros extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public SolicitudPagoFarmaciaObreros() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public SolicitudPagoFarmaciaObreros(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		SolicitudPagoFarmaciaObreros reporte = new SolicitudPagoFarmaciaObreros();
