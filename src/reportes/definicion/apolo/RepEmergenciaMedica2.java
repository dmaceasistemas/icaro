...
public class RepEmergenciaMedica2 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public RepEmergenciaMedica2() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public RepEmergenciaMedica2(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		RepEmergenciaMedica2 reporte = new RepEmergenciaMedica2();
