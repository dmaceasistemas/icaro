...
public class SolicitudPagoSedeMedicaObreros extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public SolicitudPagoSedeMedicaObreros() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public SolicitudPagoSedeMedicaObreros(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		SolicitudPagoSedeMedicaObreros reporte = new SolicitudPagoSedeMedicaObreros();
