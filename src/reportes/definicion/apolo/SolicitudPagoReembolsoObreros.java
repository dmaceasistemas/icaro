...
public class SolicitudPagoReembolsoObreros extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public SolicitudPagoReembolsoObreros() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public SolicitudPagoReembolsoObreros(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		SolicitudPagoReembolsoObreros reporte = new SolicitudPagoReembolsoObreros();
