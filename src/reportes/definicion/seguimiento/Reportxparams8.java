...
public class Reportxparams8 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public Reportxparams8() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public Reportxparams8(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		Reportxparams8 reporte = new Reportxparams8();
