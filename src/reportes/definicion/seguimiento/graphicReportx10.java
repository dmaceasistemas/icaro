...
public class graphicReportx10 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public graphicReportx10() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public graphicReportx10(HttpServletRequest request) {
		super(request);
	...
	public void cargarParametros(HttpServletRequest request) {	
		...
		this.parametros.put("valor2",mes);
		if (this.parametros.get("valor2")==null)
		{
			this.parametros.put("valor2","%");
			this.parametros.put("valor4","Consolidado Anual");
		} else 
			this.parametros.put("valor4",mes);
		
		this.parametros.put("valor3",des_ejeEst);
	...
	public Object clone() throws CloneNotSupportedException {
		graphicReportx10 reporte = new graphicReportx10();
