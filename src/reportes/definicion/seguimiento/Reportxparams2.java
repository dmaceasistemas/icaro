...
public class Reportxparams2 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public Reportxparams2() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public Reportxparams2(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		Reportxparams2 reporte = new Reportxparams2();
