...
public class Reportxparams7 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public Reportxparams7() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public Reportxparams7(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		Reportxparams7 reporte = new Reportxparams7();
