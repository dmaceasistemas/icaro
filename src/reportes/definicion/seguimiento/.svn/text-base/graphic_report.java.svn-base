...
public class graphic_report extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public graphic_report() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public graphic_report(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		graphic_report reporte = new graphic_report();
