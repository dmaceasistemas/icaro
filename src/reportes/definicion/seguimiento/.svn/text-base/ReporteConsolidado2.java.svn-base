...
public class ReporteConsolidado2 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public ReporteConsolidado2() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public ReporteConsolidado2(HttpServletRequest request) {
		super(request);
	...
	public void cargarParametros(HttpServletRequest request) {	
		...
		String tipoServicio = request.getParameter("tipoServ");
		...
		this.parametros.put("tipoServicio",tipoServicio);		
		if (this.parametros.get("tipoServicio")==null)
			this.parametros.put("tipoServicio","%");
	...
	public Object clone() throws CloneNotSupportedException {
		ReporteConsolidado2 reporte = new ReporteConsolidado2();
