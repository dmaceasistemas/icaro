...
public class graphicReportx3 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public graphicReportx3() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public graphicReportx3(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		graphicReportx3 reporte = new graphicReportx3();
