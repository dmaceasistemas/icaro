...
public class Reportxparams5 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public Reportxparams5() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public Reportxparams5(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		Reportxparams5 reporte = new Reportxparams5();
