...
public class Reportxparams4 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public Reportxparams4() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public Reportxparams4(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		Reportxparams4 reporte = new Reportxparams4();
