...
public class graphicReportx5 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public graphicReportx5() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public graphicReportx5(HttpServletRequest request) {
		super(request);
	...
	public void cargarParametros(HttpServletRequest request) {	
		...
		this.parametros.put("valor1",servicio);		
		if (this.parametros.get("valor1")==null)
			this.parametros.put("valor1","%");
		
		
		this.parametros.put("valor2",des_servicio);
	...
	public Object clone() throws CloneNotSupportedException {
		graphicReportx5 reporte = new graphicReportx5();
