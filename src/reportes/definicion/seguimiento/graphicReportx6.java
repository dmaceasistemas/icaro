...
public class graphicReportx6 extends Reporte{
	
	private HashMap<String, Object> parametros;
	
	public graphicReportx6() {
		super();
		this.parametros = new HashMap<String, Object>();
	}
	
	public graphicReportx6(HttpServletRequest request) {
		super(request);
	...
	public Object clone() throws CloneNotSupportedException {
		graphicReportx6 reporte = new graphicReportx6();
